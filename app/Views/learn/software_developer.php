...
<head>
    ...
    <title>Software Devloper - Datazen Learn</title>
    <!-- Favicon -->
...
<body>
    ...
    <nav aria-label="breadcrumb" style="padding-top: 70px;">
        <ol class="breadcrumb">
            <div class="container" style="padding: 0;">
                <li><a class="learn-links orange-text" href="../../learn.html">Learn </a></li>
                <li aria-current="page">/ Software Developer</li>
            </div>
        </ol>
    </nav>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="box-effect-two learn-cards wow fadeInUp text-left feature-box-effect selected">
                            ...
                            <div class="mt-4 watch-link">
                                <a href="https://www.linkedin.com/learning/programming-foundations-fundamentals-3?trk=li-softwaredev-programfundamentals-en&src=re-other&veh=127.0.0.1%7Cre-other"
                                    target="_blank" rel="noopener noreferrer" class="learn-links orange-text">
                                    Watch Course
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3">
                        <div class="box-effect-two learn-cards wow fadeInUp text-left feature-box-effect selected">
                            ...
                            <div class="mt-4 watch-link">
                                <a href="https://www.linkedin.com/learning/programming-foundations-databases-2?trk=li-softwaredev-programdatabases-en&src=re-other&veh=127.0.0.1%7Cre-other"
                                    target="_blank" rel="noopener noreferrer" class="learn-links orange-text">
                                    Watch Course
                                </a>
                            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="box-effect-two learn-cards wow fadeInUp text-left feature-box-effect selected">
                            ...
                            <div class="mt-4 watch-link">
                                <a href="https://www.linkedin.com/learning/succeeding-in-web-development-full-stack-and-front-end?trk=li-softwaredev-webdev-en&src=re-other&veh=127.0.0.1%7Cre-other"
                                    target="_blank" rel="noopener noreferrer" class="learn-links orange-text">
                                    Watch Course
                                </a>
                            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="box-effect-two learn-cards wow fadeInUp text-left feature-box-effect selected">
                            ...
                            <div class="mt-5 watch-link">
                                <a href="https://www.linkedin.com/learning/html-essential-training-4?trk=li-softwaredev-html-en&src=re-other&veh=127.0.0.1%7Cre-other"
                                    target="_blank" rel="noopener noreferrer" class="learn-links orange-text mt-5">
                                    Watch Course
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3">
                        <div class="box-effect-two learn-cards wow fadeInUp text-left feature-box-effect selected">
                            ...
                            <div class="mt-5 watch-link">
                                <a href="https://www.linkedin.com/learning/css-essential-training-3?trk=li-softwaredev-css-en&src=re-other&veh=127.0.0.1%7Cre-other"
                                    target="_blank" rel="noopener noreferrer" class="learn-links orange-text mt-5">
                                    Watch Course
                                </a>
                            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="box-effect-two learn-cards wow fadeInUp text-left feature-box-effect selected">
                            ...
                            <div class="mt-5 watch-link">
                                <a href="https://www.linkedin.com/learning/javascript-essential-training-3?trk=li-softwaredev-javascript-en&src=re-other&veh=127.0.0.1%7Cre-other"
                                    target="_blank" rel="noopener noreferrer" class="learn-links orange-text mt-5">
                                    Watch Course
                                </a>
                            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="box-effect-two learn-cards wow fadeInUp text-left feature-box-effect selected">
                            ...
                            <div class="mt-5 watch-link">
                                <a href="https://www.linkedin.com/learning/learning-python-2?trk=li-softwaredev-python-en&src=re-other&veh=127.0.0.1%7Cre-other"
                                    target="_blank" rel="noopener noreferrer" class="learn-links orange-text mt-5">
                                    Watch Course
                                </a>
                            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="box-effect-two learn-cards wow fadeInUp text-left feature-box-effect selected">
                            ...
                            <div class="mt-5 watch-link">
                                <a href="https://www.linkedin.com/learning/learning-sql-programming?trk=li-softwaredev-sql-en&src=re-other&veh=127.0.0.1%7Cre-other"
                                    target="_blank" rel="noopener noreferrer" class="learn-links orange-text mt-5">
                                    Watch Course
                                </a>
                            </div>
    ...
    <!--footer and subscribe box-->
    <div id="footer"></div>
    <!--footer and subscribe box end-->
